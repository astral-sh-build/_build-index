...
```text
https://wheels.astralshosted.com/simple/<channel>/
```
...
```text
https://wheels.astralshosted.com/simple/cu128/
...
```bash
INDEX_URL=https://wheels.astralshosted.com/simple/cu128/
...
[index]: https://wheels.astralshosted.com/index.html
